  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 px-8 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Teacher Create Announcements</h1>
          <p className="text-sm text-gray-400 mt-1">Create and manage announcements for students</p>
        </div>

        <button
          onClick={() => navigate("create-teacher-annoucement")}
...
export default AnnoucmentTeacher;