        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 px-10 py-10">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Kindly provide your email and password to access the student portal.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="w-full py-3 mt-1 rounded-xl bg-[#1e3a6e] hover:bg-[#162d56] active:scale-95 text-white text-sm font-bold tracking-widest uppercase transition-all duration-150 flex items-center justify-center gap-2 disabled:opacity-70"
            >
              {loading ? (
            ...
            <div className="text-center">
              <button
                ...
                className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-700 transition font-medium"
              >
                <FiArrowLeft size={13} />
                Login as trainer
              </button>
